...
2026年度版 `Ver.1.03.4` のBug Fix版として、カリキュラムツリー表示、卒業要件判定、演出付きUI、SE/BGM、BGM可視化を含む完成版の履修計画チェッカーです。
...
- 判定の「その他52単位」の内訳を、基礎振替10単位まで、他学科12単位まで、他大学認定30単位までの区分に合わせて整理しました。
