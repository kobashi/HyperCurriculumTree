...
2026年度版 `Ver.1.03.6` のBug Fix版として、カリキュラムツリー表示、卒業要件判定、演出付きUI、SE/BGM、BGM可視化を含む完成版の履修計画チェッカーです。
...
- 専門科目全体の内訳表示に、自コース・他コース・専門共通の積み上がりが見えるようにしました。

### Ver.1.03.6 の修正

- その他52単位の内訳で、専門教育科目と単位認定を分離しました。専門教育科目は専門共通、自コース、他コース、専門選択に分けて表示します。
