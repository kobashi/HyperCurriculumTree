...
2026年度版 `Ver.1.03.5` のBug Fix版として、カリキュラムツリー表示、卒業要件判定、演出付きUI、SE/BGM、BGM可視化を含む完成版の履修計画チェッカーです。
...
- 専門教育の内訳表示に、自コース・他コース・専門共通・他学科・単位認定の積み上がりが見えるようにしました。
